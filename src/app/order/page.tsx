    ...
    <div className='flex flex-col w-full h-full'>
      ...
      <div className='w-full flex items-center h-[70px] bg-white border-b relative pr-4'>
        ...
        <button
            ...
            >
              <div class="text-black" data-icon="Globe" data-size="20px" data-weight="regular">
      ...
      <div className=' flex items-center justify-center flex-col w-full h-full'>
        <div className='flex flex-col items-center  justify-center  pb-10'>
          ...
          <div className="text-[4vw] font-fontBold ">Restaurant</div>
        </div>
        <div className='bg-white w-[50%] h-[30vh] rounded-xl shadow-xl cursor-pointer overflow-hidden ' >
           ...
           <div>
           <span className=' font-fontBold text-[18px]'> Otentik Niort</span>
